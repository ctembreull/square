...
ActiveRecord::Schema[7.1].define(version: 2024_03_18_193242) do
  ...
  create_table "affiliations", force: :cascade do |t|
    ...
    t.index ["league_id", "team_id"], name: "index_affiliations_on_league_id_and_team_id", unique: true
  ...
  create_table "games", force: :cascade do |t|
    ...
    t.integer "periods", default: 0, null: false
    t.string "score_url"
  ...
  create_table "teams", force: :cascade do |t|
    ...
    t.virtual "search_index", type: :text, as: "((((lower((abbr)::text) || ' '::text) || lower((location)::text)) || ' '::text) || lower((name)::text))", stored: true
    t.index ["search_index"], name: "teams_search_idx"
  end
